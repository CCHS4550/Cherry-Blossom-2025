...
public class ModuleIOSpark implements ModuleIO {
  ...
  // the absolute encoder will be off from the true wheel angle, we can use this measurement to account for that
  ...
  public ModuleIOSpark(int module) {
     ...
     * 
     * this is now automatically applied anytime we request motor information
     * 
     * average depth is the bit size of the sampling depth, must be a power of 2
     */
    turnConfig
        .absoluteEncoder
     ...
     * 
     * feedbackSensor sets our sensor to the absolute encoder
     * position wrapping makes it loop from the given range which we set to 0 and 2pi
     * 
     * then we set the pid configs
     * ff = 0 because they do not take into account ks and their calc isnt amazing
     * instead we will implement ff as an arbff to be added later
     */
    turnConfig
        .closedLoop
     ...
     * we set the encoder speed to the a calculation converting odometry frequency to ms
     * 
     * set the velocity to always give output
     * 
     * set every other periodic function in the motor to 20ms the standard
     */
    turnConfig
        .signals
    ...
    */    
     ...
     * 
     * feedbackSensor sets our sensor to the absolute encoder
     * no pos wrapping because we want the total num of rotations for odometry
     * 
     * then we set the pid configs
     * ff = 0 because they do not take into account ks and their calc isnt amazing
     * instead we will implement ff as an arbff to be added later
