...
public class Lights extends SubsystemBase {
    ...
    private Lights(Pneumatics pneumatics) {
        ...
        case pinkWhiteGradient:
          ...
          for (var i = 0; i < 93; i++) {
            ...
            final var saturation =
                (pinkWhiteGradientFirstPixelSaturation + (i * 210 / ledBuffer.getLength())) %
210;
            // Set the value
        ...
        case pressureRedtoGreenGradient:
          ...
          for (var i = 93; i < 169; i++) {
            ...
            ledBuffer.setHSV(i, outputHue, testV,
pressureRedtoGreenGradientFirstPixelSaturation);
    ...
    private void convertHSV() {
      inputPSI = (float) pneumatics.getPSI();
