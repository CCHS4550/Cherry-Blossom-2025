...
public class Barrel extends SubsystemBase {
  ...
  private SimpleMotorFeedforward veloFF =
      new SimpleMotorFeedforward(
          0, 0, 0); // feedforward to calculate voltage needed to get to the given setpoint of the
  // trapezoidal motion profile

  // motion profiling
  private TrapezoidProfile.Constraints constraints =
      new Constraints(
          0, 0); // max speed and acceleration of the profile, in meters per second and meters per
  // second^2
