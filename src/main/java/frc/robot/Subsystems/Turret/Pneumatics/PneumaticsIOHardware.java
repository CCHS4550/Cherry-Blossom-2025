...
public class PneumaticsIOHardware implements PneumaticsIO{
    ...
    public PneumaticsIOHardware() {
        ...
        compressorFan = new Compressor(Constants.PneumaticConstants.compressorFanPort, PneumaticsModuleType.REVPH);
        pressureSeal = new DoubleSolenoid(Constants.PneumaticConstants.compressorFanPort, PneumaticsModuleType.REVPH, Constants.PneumaticConstants.pressureSealForward, Constants.PneumaticConstants.pressureSealBackward);
        shootingSeal = new Solenoid(Constants.PneumaticConstants.compressorFanPort, PneumaticsModuleType.REVPH, Constants.PneumaticConstants.shootingSeal);
    ...
    public void updateInputs(PneumaticsIOInputs inputs) {
        ...
        ifOK(compressor, new DoubleSupplier[] {compressor::getAppliedOutput, compressor::getBusVoltage},
